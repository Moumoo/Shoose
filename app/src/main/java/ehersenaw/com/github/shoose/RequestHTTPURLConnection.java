...
public class RequestHTTPURLConnection {
    ...
    public String request(String _url, ContentValues _params) {
        ...
        try{
            ...
            String strParams = sbParams.toString(); // Save sbParams's Parameters as string. ex) id=id1&pw=p123;
            JSONObject job = new JSONObject();
            job.put("ID", "asdf");
            job.put("password", "asdfPass");

            OutputStream os = urlConn.getOutputStream();
            os.write(job.toString().getBytes("UTF-8")); // Print to output stream.
            ...
            String ID_result = (String) responseJSON.get("ID");
            String PW_result = (String) responseJSON.get("password");
